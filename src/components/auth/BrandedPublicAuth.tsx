    ...
    <BrandedContainer branding={branding}>
      ...
      {isMfaChallengeFlow && (
        <div className="fixed inset-0 z-50 bg-black/55 backdrop-blur-[1px] flex items-center justify-center px-4">
          <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-indigo-100 p-6 space-y-5">
            <div className="space-y-1">
              <p className="text-xs font-semibold uppercase tracking-wide text-indigo-500">Verificación MFA</p>
              <h3 className="text-xl font-semibold text-indigo-950">Aprobación en curso</h3>
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50 px-5 py-4">
              <p className="text-sm font-medium text-indigo-800">Número de verificación</p>
              <p className="text-4xl font-bold tracking-[0.35em] text-indigo-950 mt-1">{mfaVerificationNumber || '--'}</p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 text-sm">
              ...
              <button
                ...
                className="font-medium text-indigo-700 hover:text-indigo-900 underline underline-offset-2 disabled:opacity-60"
                disabled={loading}
              >
              ...
              <div className="rounded-xl border border-indigo-100 bg-white p-4 space-y-3">
                ...
                {mfaChallengeCode && (
                  <p className="text-xs text-indigo-700">
                    Código actual: <span className="font-semibold">{mfaChallengeCode}</span> · expira en {Math.max(1, Math.floor(mfaCodeExpiresIn))} s
                  </p>
                )}
              </div>
            )}
